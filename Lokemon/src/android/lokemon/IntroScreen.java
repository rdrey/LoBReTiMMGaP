...
public class IntroScreen extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)second[4]).setText(Pokemon.pokemon[0].getDescription());
        ((TextView)second[5]).setText(Html.fromHtml(Pokemon.pokemon[0].getBaseStats()));
    }
    ...
    public void onCheckedChanged(CompoundButton b, boolean checked)
    {
    	if (checked)
    	{
    		...
    		if (b == bulbasaur) {textView.setText(Pokemon.pokemon[0].getDescription());
    		stats.setText(Html.fromHtml(Pokemon.pokemon[0].getBaseStats()));}
    		else if (b == charmander) {textView.setText(Pokemon.pokemon[3].getDescription());
    		stats.setText(Html.fromHtml(Pokemon.pokemon[3].getBaseStats()));}
    		else if (b == squirtle){ textView.setText(Pokemon.pokemon[6].getDescription());
    		stats.setText(Html.fromHtml(Pokemon.pokemon[6].getBaseStats()));}
    	}
    }
